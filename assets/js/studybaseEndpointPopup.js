(function () {
  ...
  function ensureToast() {
    ...
    toast.innerHTML = [
      ...
      "    <div>",
      '      <p class="sb-endpoint-toast-title">An unexpected endpoint error occurred</p>',
      '      <p class="sb-endpoint-toast-copy">Click for more details.</p>',
      '      <div class="sb-endpoint-toast-code" data-field="toast-code">Code: Unknown</div>',
      "    </div>",
      "  </div>",
      '  <div class="sb-endpoint-toast-actions">',
