(function () {
  const DEFAULT_CONFIG = {
    brand: {
      ...
      shortName: "RevisionBase",
      securityName: "Revision Base Security Checkpoint",
      tagline:
    ...
    icons: {
      ...
      appleTouch: "/assets/siteIcons/navbar.png"
    },
    ui: {
      theme: {
    ...
    endpoints: {
      apiBase: "https://api.revisionbase.site",
      loginState: "https://api.revisionbase.site/state",
      apgList: "https://alert-api.revisionbase.site/apg/list",
      reportProblem: "https://report-problem.revisionbase.site",
      resourceList: "https://api.revisionbase.site/resources/list",
      resourceGet: "https://api.revisionbase.site/resource/get",
      resourceState: "https://api.revisionbase.site/state",
      resourceTopCards: "https://api.revisionbase.site/resources/top-cards",
      consentLog:
      ...
      update: "https://update.revisionbase.site"
    },
    environment: {
      testMode: false,
      showDebugLogs: false,
    ...
    resources: {
      dataBase: "/assets/resourceData/alevel",
      rootFolder: "000",
    ...
    autoSafe: {
      enabled: true,
      badWordsUrl: "/autoSafe/data/badWords.txt",
      mainInput: {
        enabled: true,
        debug: false,
    ...
    updates: {
      enabled: true,
      endpoint: "https://update.revisionbase.site",
      versionPath: "/version",
      execPath: "/exec",
      execEnabled: true,
      modalEnabled: true,
    ...
    timeLimits: {
      maintenance: {
        ...
        warningMessage: "To protect infrastructure stability and proactively reduce overnight server load, RevisionBase will initiate its standard automated shutdown at 11:02 PM.",
        restoreMessage: "Services will automatically restore at 4:00 AM. Please save your current work.",
        shutdownTitle: "RevisionBase is currently offline for servicing",
        shutdownMessage: "RevisionBase undergoes scheduled daily maintenance between 11:02 PM and 4:00 AM.",
      ...
      wellbeingBreak: {
        ...
        pill: "RevisionBase Wellbeing"
      }
    },
    settings: {
      pageTitle: "Your Settings",
      pageDescription: "Control how RevisionBase behaves on this device.",
      ...
      setupBrandLabel: "RevisionBase setup",
      closeMessageTarget: "*",
    ...
    account: {
      ...
      sessionStorageKeys: {
        expiry: "sb_sessionExpiry",
        expirySetAt: "sb_sessionExpirySetAt"
      },
